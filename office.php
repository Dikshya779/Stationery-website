			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick1.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
						...
						<span class="product-new-label">File Folders</span>
						<ul class="rating">
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick1.php">File Folders</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick2.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						...
						<span class="product-new-label">Desk</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick2.php">Desk Manager</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick3.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						...
						<span class="product-new-label">Paper</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick3.php">A4 size Paper</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick4.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						</ul>

						<span class="product-new-label">Tape</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick4.php">Desk Tape </a>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick7.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						...
						<span class="product-new-label">Note</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick7.php">
								Sticky Notes</a></h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="offices/oquick8.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						...
						<span class="product-new-label">Envelopes</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="offices/oquick8.php">Clasp Envelopes </a>
						</h3>
