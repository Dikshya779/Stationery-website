			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick1.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
						...
						<span class="product-new-label">Spiral Notebook</span>
						<ul class="rating">
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick1.php">Spiral-notebook</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						<a href="#">
							<img class="pic-1"
								src="assets/pens.webp">
							<img class="pic-2"
								src="assets/pens.webp">
						</a>

						<ul class="social">
							<li><a href="schools/squick2.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>

						</ul>

						<span class="product-new-label">Pens</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick2.php">Pens</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick3.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>

						</ul>

						<span class="product-new-label">Binder</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick3.php">Ring Binder
								Black</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick4.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						</ul>

						<span class="product-new-label">Ruler</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick4.php">Ruler </a>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick5.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>

							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						</ul>

						<span class="product-new-label">Case</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick5.php">Pencil-Case</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick6.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
						...
						<span class="product-new-label">Backpack</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick6.php">Student Backpack</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick7.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>

						</ul>

						<span class="product-new-label">Notebook</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick8.php">Notebook </a></h3>
						<div class="price">Rs.500</div>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="schools/squick8.php" data-tip="Quick View"> <i class="fa fa-search"></i></a>
							</li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
					...
					<div class="product-content">
						<h3 class="title"><a href="schools/squick8.php">Notebook </a>
						</h3>
