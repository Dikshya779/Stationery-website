			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick1.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick1.php">Crayons</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick2.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick2.php">Handmade Art canvas</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick3.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick3.php">Paint Brush Set</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick4.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>

						</ul>

						<span class="product-new-label">Paint</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick4.php">Markers Paint Set </a>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick5.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>


						</ul>

						<span class="product-new-label">Set</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick5.php">DIY Journaling Set</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick6.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>


						</ul>

						<span class="product-new-label">Markers</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick6.php">Permanent Paint Markers</a>
						</h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick7.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>


						</ul>

						<span class="product-new-label">Stick</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick7.php">
								Craft Stick </a></h3>
			...
			<div class="col-lg-3 col-sm-6">
				<div class="product-grid">
					<div class="product-image">
						...
						<ul class="social">
							<li><a href="arts/aquick8.php" data-tip="Quick View"> <i class="fa fa-search"></i></a></li>
							<li><a href="#" data-tip="Add to Cart"> <i class="fa fa-shopping-cart"></i></a></li>


						</ul>

						<span class="product-new-label">Stickers</span>
					...
					<div class="product-content">
						<h3 class="title"><a href="arts/aquick8.php">Eyes Sticker Roll </a>
						</h3>
